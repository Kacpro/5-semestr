...
public class PhotoDownloader {
    ...
    public Observable<Photo> searchForPhotos(String searchQuery) throws IOException {
        Observable<Photo> photos = Observable.create(observer -> {
        	try {
    ...
    public Observable<Photo> searchForPhotos(List<String> searchQueries) throws IOException {
        Observable<Photo> photos = Observable.fromIterable(searchQueries).flatMap(query -> searchForPhotos(query)).subscribeOn(Schedulers.io());
        return photos;
    }
